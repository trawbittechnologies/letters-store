        ...
        <div className="border border-[var(--border-dark)] bg-[var(--card)] p-8 sm:p-12 lg:p-14">
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
            ...
            <div className="max-w-xl">
              <div className="inline-flex items-center gap-2 px-2.5 py-1 bg-[var(--bg)] border border-[var(--border-dark)] text-[9px] font-bold tracking-[0.2em] uppercase mb-4 text-[var(--text)]">
            ...
            <div className="flex flex-col items-start sm:items-center gap-3 w-full sm:w-auto">
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-8 py-4 text-[11px] font-bold uppercase tracking-[0.2em] bg-[#25D366] text-white hover:bg-[#1EBE5D] border border-[#25D366] transition-colors cursor-pointer"
              >
